...
def study_image():
    ...
    posting=requests.post(api_url, headers=headers, data=json.dumps(data))
    convpost=json.loads(posting.content)
    '''img=convpost["inputs"][0]["url"]'''
    return render_template('home.html', results=convpost)
